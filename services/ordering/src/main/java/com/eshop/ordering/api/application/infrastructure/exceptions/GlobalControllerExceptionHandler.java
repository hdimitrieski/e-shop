...
//    }
  ...
  public HttpErrorInfo constraintViolationException(ServerHttpRequest request, Exception ex) {
  ...
  public @ResponseBody
  HttpErrorInfo handleCatalogDomainExceptions(ServerHttpRequest request, Exception ex) {
    return createHttpErrorInfo(BAD_REQUEST, request, ex);
  }
  ...
  public @ResponseBody
  HttpErrorInfo handleUnhandledExceptions(ServerHttpRequest request, Exception ex) {
